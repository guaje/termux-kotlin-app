...
object NerdFontCatalog {
    ...
    val entries: List<NerdFontCatalogEntry> = listOf(
        ...
        entry("fira_code", "FiraCode", "FiraCode.zip", "8ad2834d8ea1945d8ab042538e608f6370573a29913aa94b5e6bbc92ffacbab5", 28061509L, isMonospaced = true, bundled = false, primaryFontSupported = true),
        ...
        // Hack is the one Nerd Font shipped as a built-in (see FontManager.bundledFonts),
        ...
        entry("jetbrains_mono", "JetBrainsMono", "JetBrainsMono.zip", "9577de1ae84ec523df16fc69bac5338b89497a5b4fb91489e2dcb79dc06ac2b5", 131540280L, isMonospaced = true, bundled = false, primaryFontSupported = true),
